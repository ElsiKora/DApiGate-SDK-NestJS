...
export class Configuration {
	 ...
	 */
	public selectHeaderAccept(accepts: Array<string>): string | undefined {
		if (accepts.length === 0) {
			return undefined;
		}
	 ...
	 * @returns the selected content-type or <code>undefined</code> if no selection could be made.
	 */
	public selectHeaderContentType(contentTypes: Array<string>): string | undefined {
...
export interface ConfigurationFactory {
	createConfiguration(): Configuration | Promise<Configuration>;
}
...
export interface AsyncConfiguration extends Pick<ModuleMetadata, "imports"> {
	 ...
	 */
	useFactory?: (...arguments_: Array<any>) => Configuration | Promise<Configuration>;
}
